...
test('Form', async t => {
        await menuItem;
        await t.wait(3000);
        await ScreenComparer.Compare(t, `01.HomeView`);
        await t.click(menuItem);
        await t.wait(3000);
        await ScreenComparer.Compare(t, "02.FormView");

        await t.expect(datebox['setValue'](new Date(2014, 4, 26))).notOk()
        await ScreenComparer.Compare(t, "03.FormView");
        await t.typeText(loginInput, "MyName")
               .typeText(passwordInput, "MyPassword")
               .click(dateboxButton)

        await ScreenComparer.Compare(t, "04.FormView");
        ...
        await ScreenComparer.Compare(t, "05.FormView");
        await t.typeText(autoComplit, "new")
            ...
            .click(fieldHeader.withText("Selectable"))
        await ScreenComparer.Compare(t, "06.FormView");
        ...
        await ScreenComparer.Compare(t, "07.FormView");
        await t.click(fieldHeader.withText("Sliders"))
            ...
            .click(button.nth(2))
            .click(button.nth(3))
        await ScreenComparer.Compare(t, "08.FormView");
